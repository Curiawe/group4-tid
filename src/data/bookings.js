...
export const BOOKINGS = [
    {Ref: "814", Status: bookingStates.PICKEDUP,isWalkin: false,carGroup: CARGROUPS[0], Customer: CUSTOMERS[0], Car: null, Pickup: {time: new Date(2021,11,29,10), location: LOCATIONS[0], mileage:0}, BillAs:null, Return: {time: new Date(2021,11,30,10), location:LOCATIONS[0], mileage: 0}, Services: {driver: true, mileage:0}, Returned: {time:null, mileage:0}, price:pricing(1), Comment:""},
